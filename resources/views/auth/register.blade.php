                ...
                <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('register') }}">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <x-text-input id="name" name="name" type="text" class="block w-full ps-10 text-start" :value="old('name')" required autofocus autocomplete="name" :placeholder="__('auth_pages.name_placeholder')" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <x-text-input id="email" name="email" type="email" class="block w-full ps-10 text-start" :value="old('email')" required autocomplete="username" :placeholder="__('auth_pages.email_placeholder')" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                                {{-- UPDATED ICON --}}
                                <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                  <path d="M15.992 11.285c-1.28 0-2.514.2-3.693.606a.75.75 0 0 1-.88-.09l-1.42-1.14a13.4 13.4 0 0 0-4.99-4.99l-1.14-1.42a.75.75 0 0 1-.09-.88c.402-1.178.605-2.412.605-3.693a.75.75 0 0 0-.75-.75H1.75a.75.75 0 0 0-.75.75c0 9.808 7.942 17.75 17.75 17.75a.75.75 0 0 0 .75-.75v-2.344a.75.75 0 0 0-.75-.75Z"/>
                                </svg>
                            </div>
                            <x-text-input id="phone_number" name="phone_number" type="tel" class="block w-full ps-10 text-start" :value="old('phone_number')" required autocomplete="tel" :placeholder="__('auth_pages.phone_placeholder')" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <x-text-input id="government_id" name="government_id" type="text" class="block w-full ps-10 text-start" :value="old('government_id')" required autocomplete="off" :placeholder="__('auth_pages.government_id_placeholder')" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <x-text-input id="password" class="block w-full ps-10 text-start" type="password" name="password" required autocomplete="new-password" :placeholder="__('auth_pages.password_placeholder')" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <x-text-input id="password_confirmation" class="block w-full ps-10 text-start" type="password" name="password_confirmation" required autocomplete="new-password" :placeholder="__('auth_pages.password_placeholder')" />
                        </div>
