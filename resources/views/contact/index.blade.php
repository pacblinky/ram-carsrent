        ...
        <section class="max-w-screen-xl mx-auto py-16 px-4 -mt-16">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="space-y-8 z-10 opacity-0 translate-y-8 transition-all duration-1000 delay-200 ease-out animate-on-scroll">
                    ...
                    {{-- Contact Info Block (SPACING FIX APPLIED HERE) --}}
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 md:p-8">
                        ...
                        <div class="space-y-4 text-gray-600 dark:text-gray-400">
                            ...
                            <p class="flex items-center gap-3">
                                ...
                                <a href="tel:+9960562882828">
                                    <span dir="ltr">{{ __('contact.info_phone') }}</span>
                                </a>
                            </p>
                            {{-- Email --}}
                            <p class="flex items-center gap-3">
                                ...
                                <a href="mailto:support@ramco.com.sa">
                    ...
                    {{-- Locations & Map Block --}}
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 md:p-8">
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">{{ __('contact.locations_title') }}</h3>
