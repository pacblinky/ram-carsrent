...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Validation Language Lines (خطوط لغة التحقق من الصحة)
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    'digits_between' => 'يجب أن يتراوح حقل :attribute بين :min و :max أرقام.',
    ...
    'min' => [
        ...
        'string' => 'يجب أن يتكون حقل :attribute من :min حرفًا على الأقل.',
    ],
    ...
    'password' => [
        ...
        'uncompromised' => 'ظهر :attribute المُعطى في تسريب بيانات. يرجى اختيار :attribute مختلف.',
    ],
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Custom Validation Attributes (سمات التحقق المخصصة)
    |--------------------------------------------------------------------------
    |
